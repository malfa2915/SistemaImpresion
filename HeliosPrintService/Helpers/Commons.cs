...
namespace HeliosPrintService.Helpers
{
    public class Commons
    {
        public void ImprimirPedido(List<detalleItemsImpresoras> order, String ISPRINTER, String nameMesa, String nameVendedor, String nameAlmacen, String namecargo, String NombreInfra)
        {
            try
            {
