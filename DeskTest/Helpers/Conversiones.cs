        ...
        private static string ToText(decimal value)
        {
            ...
            else
            {
                ...
                if ((value - Math.Truncate(value / Billon) * Billon) > 0)
                    num2Text = $"{num2Text} {ToText(value - Math.Truncate(value / Billon) * Billon)}";
            }
